                            ...
                            <div class="pd-breadcrumb u-s-m-b-30">
                                <ul class="pd-breadcrumb__list">
                                    <li class="has-separator">
                                        ...
                                        <a href="{{route('frontend.homepage')}}">Home</a></li>
                                    <li class="has-separator">
                            ...
                            <div class="pd u-s-m-b-30">
                                <div class="slider-fouc pd-wrap">
                                    <div id="pd-o-initiate">
                                        <div class="pd-o-img-wrap" data-src="{{$product_details->getFirstMediaUrl('products')}}">

                                            <img class="u-img-fluid" src="{{$product_details->getFirstMediaUrl('products')}}" data-zoom-image="{{$product_details->getFirstMediaUrl('products')}}" alt="{{$product_details->title}}"></div>
                                    ...
                                    <div class="slider-fouc">
                                        <div id="pd-o-thumbnail">
                                            <div>
                                                ...
                                                <img class="u-img-fluid" src="{{$product_details->getFirstMediaUrl('products')}}" alt="{{$product_details->title}}"></div>
                                            <div>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="pd-detail">
                                <div>
                                    ...
                                    <span class="pd-detail__name">{{$product_details->product_title}}</span></div>
                                <div>
                                    <div class="pd-detail__inline">

                                        <span class="pd-detail__price">BDT {{$product_details->product_price}}</span>
                                ...
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
                                        ...
                                        <span class="pd-detail__stock">{{$product_details->in_stock}} in stock</span>

                                        <span class="pd-detail__left">Only 2 left</span></div>
                                </div>
                                <div class="u-s-m-b-15">

                                    <span class="pd-detail__preview-desc">{{$product_details->product_description}}</span></div>
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
