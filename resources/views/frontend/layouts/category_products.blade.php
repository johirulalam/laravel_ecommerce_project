                                            ...
                                            <div class="product-m">
                                                ...
                                                <div class="product-m__content">
                                                    <div class="product-m__category">
                                                        ...
                                                        <a href="shop-side-version-2.html">{{$category_product->product_name}}</a></div>
                                                    <div class="product-m__name">

                                                        <a href="{{route('product.details', $category_product->product_slug)}}">{{$category_product->product_title}}</a></div>
